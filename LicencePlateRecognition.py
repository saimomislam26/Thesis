...
cap = cv2.VideoCapture('VID_20210408_132024.mp4')
        ...
        while True:
            ...
            for i in range(num_detections):
                ...
                if score > 0.9 and classId == 2:
                    ...
                    text_height = .8
                    cv2.rectangle(image_np, (x, y), (right, bottom), (125, 255, 51), thickness=2)
                    cv2.putText(image_np, text, (x, bottom + 19),
                                cv2.FONT_HERSHEY_SIMPLEX, text_height, (125, 255, 51), 2)
